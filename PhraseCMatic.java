public class PhraseCMatic {
	public static void main (String[] args) {
		...
		String[] wordListOne = {"круглосуточный", "трех-звенный", "30000-футовьй", "взаимный", "обовдный выигрыш", "фронтэнд", "на основе веб-технологий", "проникащий", "умный", "шесть сит", "метод критического пути", "динамичный"};
